...
export function ToolCallingPanel() {
  ...
  const saveConfig = (updates: Partial<ToolCallingConfig>) => {
    if (!appConfig) return
    const merged: ToolCallingConfig = {
      ...config,
      ...updates,
      advanced: {
        ...config.advanced,
        promptPreviewEnabled: config.advanced.promptPreviewEnabled,
        ...(updates.advanced || {}),
      },
    }
    saveAppConfig({ toolCallingConfig: merged })
  }
            ...
            <div className="space-y-2">
              ...
              <Textarea
                ...
                onChange={(event) => {
                  ...
                  saveConfig({
                    advanced: {
                      customPromptTemplate: value ? value : config.advanced.customPromptTemplate,
                      promptPreviewEnabled: config.advanced.promptPreviewEnabled,
                    },
                  })
                }}

 ...
 */
export type AuthType = 'oauth' | 'token' | 'cookie' | 'userToken' | 'refresh_token' | 'jwt' | 'realUserID_token' | 'tongyi_sso_ticket';
/**
...
export declare const DEEPSEEK_PRIMARY_MODELS: string[];
export declare const DEEPSEEK_LEGACY_MODEL_MAPPING_NAMES: string[];
/**
 ...
 */
export declare const DEFAULT_STATISTICS: PersistentStatistics;
/**
 * Default User Model Overrides
 */
export declare const DEFAULT_USER_MODEL_OVERRIDES: UserModelOverrides;
export declare const DEFAULT_TOOL_CALLING_CONFIG_VALUE: ToolCallingConfig;
/**
 * Default Management API Configuration
 */
export declare const DEFAULT_MANAGEMENT_API_CONFIG: ManagementApiConfig;
/**
 * Default Context Management Configuration
 */
export declare const DEFAULT_CONTEXT_MANAGEMENT_CONFIG: ContextManagementConfig;
export declare const DEFAULT_REQUEST_LOG_CONFIG: RequestLogConfig;
export declare const DEFAULT_DEEPSEEK_MODEL_MAPPINGS: Record<string, ModelMapping>;
export declare function createDefaultModelMappings(): Record<string, ModelMapping>;
export declare function isDefaultModelMapping(requestModel: string): boolean;
export declare function normalizeModelMappingsWithDefaults(mappings?: Record<string, ModelMapping>): Record<string, ModelMapping>;
export declare function sanitizeDeepSeekModelOverrides(overrides?: ProviderModelOverrides): ProviderModelOverrides;
/**

  ...
  const providerGuides: Record<string, {
    ...
    stepfun: {
      ...
      steps: [
        ...
        t('oauth.step2'),
        t('oauth.step3'),
        'In Cookies → platform.stepfun.com',
        'Find Oasis-Token field and copy its value',
        t('loginGuide.paste'),
      ],
    },
    mimo: {
      ...
      steps: [
        ...
        t('oauth.step2'),
        t('oauth.step3'),
        'In Cookies → aistudio.xiaomimimo.com',
        'Find serviceToken, userId, xiaomichatbot_ph fields',
        'Or use OAuth login tab for automatic extraction',
        t('loginGuide.paste'),
      ],
    },
    perplexity: {
      ...
      steps: [
        ...
        t('oauth.step2'),
        t('oauth.step3'),
        'In Cookies → www.perplexity.ai',
        'Find __Secure-next-auth.session-token field',
        t('loginGuide.paste'),
      ],
    },
  }

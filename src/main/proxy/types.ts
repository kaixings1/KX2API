...
export interface ForwardResult {
  ...
  extractedTools?: ExtractedToolDefinition[]
  /** True when tool_calls were auto-generated by the proxy (declarative intent extraction) */
  generatedByProxy?: boolean
  /** Actual upstream URL used for this request */
  url?: string
}
...
/**
 * Tool Extraction Confidence Level
 */
export type ExtractionConfidence = 'high' | 'medium' | 'low'

/**
 * Extracted Tool Definition (from web content)
 */
...
/**
 * Tool Extractor Input
 */
export interface ToolExtractorInput {
  content: string
  contentTypeHint?: 'html' | 'markdown' | 'text' | 'json'
  minConfidence?: ExtractionConfidence
  debug?: boolean
}

/**
 * Tool Extractor Interface
 */
export interface ToolExtractor {
  id: string
  name: string
  priority: number
  extract(input: ToolExtractorInput): ExtractedToolDefinition[]
}

/**
 * Tool Extraction Configuration
 */
export interface ToolExtractionConfig {
  enabled: boolean
  minConfidence: ExtractionConfidence

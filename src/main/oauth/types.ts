  ...
  deepseek: [
    {
      ...
      tokenType: 'token',
      label: 'User Token',
      placeholder: '填入从浏览器 LocalStorage 获取的 userToken',
  ...
  glm: [
    {
      ...
      description: '登录 chatglm.cn 后，从 Cookie 或接口响应中获取 refresh_token',
  ...
  qwen: [
    {
      ...
      description: '登录 www.qianwen.com 后，从 Cookie 中获取 tongyi_sso_ticket',
  ...
  perplexity: [
    {
      ...
      description: '从 perplexity.ai 的浏览器开发者工具获取 Cookie，或导入 HAR 文件',
  ...
  stepfun: [
    {
      ...
      tokenType: 'token',
      label: 'API Key',
      placeholder: 'Enter your StepFun API key (sk-...)',
      description: 'Get your API key from https://platform.stepfun.com/ or open the OAuth login window to auto-extract',
  ...
  zai: [
    {
      ...
      description: 'JWT token starting with "eyJ...", obtained from chat.z.ai browser DevTools (Application → Cookies → token)',
  ...
  mimo: [
    {
      ...
      tokenType: 'cookie',
      label: 'Cookies',
      placeholder: 'Paste Mimo cookies or use OAuth login',
      description: 'Get serviceToken, userId, xiaomichatbot_ph from aistudio.xiaomimimo.com browser DevTools or use OAuth login',

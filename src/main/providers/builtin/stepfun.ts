...
export const stepfunConfig: BuiltinProviderConfig = {
  id: 'stepfun',
  name: 'StepFun',
  type: 'builtin',
  authType: 'token',
  apiEndpoint: 'https://chat.stepfun.com',
  ...
  enabled: true,
  description: 'StepFun (阶跃星辰) AI assistant, provides Step series models',
  supportedModels: [
    // Step-1 series
    'step-1-8k',
    'step-1-32k',
  ...
  credentialFields: [
    {
      ...
      type: 'password',
      required: true,
      placeholder: '请输入 StepFun 网页会话令牌（从浏览器 Cookie 中获取 Oasis-Token）',
      helpText: '登录 chat.stepfun.com 后，从浏览器 DevTools > Application > Cookies 中复制 Oasis-Token 值',
    },
    {
      name: 'web_id',
      label: 'Web ID',

  ...
  const providerGuides: Record<string, {
    ...
    deepseek: {
      ...
      steps: [
        ...
        t('oauth.step2'),
        t('oauth.step3'),
        t('loginGuide.inLocalStorage', { domain: 'chat.deepseek.com' }),
        t('loginGuide.findFieldCopy', { field: 'userToken' }),
        t('loginGuide.paste'),
      ],
    },
    qwen: {
      ...
      steps: [
        ...
        t('oauth.step2'),
        t('oauth.step3'),
        t('loginGuide.inCookies', { domain: 'www.qianwen.com' }),
        t('loginGuide.findFieldCopy', { field: 'tongyi_sso_ticket' }),
        t('loginGuide.paste'),
      ],
    },
    'qwen-ai': {
      ...
      steps: [
        ...
        t('oauth.step2'),
        t('oauth.step3'),
        `1. ${t('loginGuide.inLocalStorage', { domain: 'chat.qwen.ai' })}`,
        `   ${t('loginGuide.jwtFormatHint', { field: 'token' })}`,
        `2. ${t('loginGuide.inCookies', { domain: 'chat.qwen.ai' })} ${t('loginGuide.optionalRecommended')}`,
        `   ${t('loginGuide.copyKeyCookies', { names: 'cnaui, aui, sca, cna' })}`,
        t('loginGuide.paste'),
      ],
    },
    glm: {
      ...
      steps: [
        ...
        t('oauth.step2'),
        t('oauth.step3'),
        t('loginGuide.inCookies', { domain: 'chatglm.cn' }),
        t('loginGuide.findField', { field: 'chatglm_refresh_token' }),
        t('loginGuide.paste'),
      ],
    },
    kimi: {
      ...
      steps: [
        ...
        t('oauth.step1'),
        t('oauth.step2'),
        t('loginGuide.openDevtoolsCookies'),
        t('loginGuide.findField', { field: 'kimi-auth' }),
        t('loginGuide.copyJwtToken'),
        t('loginGuide.paste'),
      ],
    },
    minimax: {
      ...
      steps: [
        ...
        t('oauth.step2'),
        t('oauth.step3'),
        t('loginGuide.inLocalStorage', { domain: 'agent.minimaxi.com' }),
        t('loginGuide.findFields', { fields: 'user_id、token' }),
        t('loginGuide.paste'),
      ],
    },
    zai: {
      ...
      steps: [
        ...
        t('oauth.step2'),
        t('oauth.step3'),
        t('loginGuide.inCookies', { domain: 'chat.z.ai' }),
        t('loginGuide.jwtFormatHint', { field: 'token' }),
        t('loginGuide.paste'),
      ],
    },
    stepfun: {
      ...
      steps: [
        t('loginGuide.openWebsite', { provider: t('stepfun.name') }),
        t('oauth.step1'),
        t('oauth.step2'),
        t('oauth.step3'),
        t('loginGuide.inCookies', { domain: 'platform.stepfun.com' }),
        t('loginGuide.findFieldCopy', { field: 'Oasis-Token' }),
        t('loginGuide.paste'),
      ],
    },
    mimo: {
      ...
      steps: [
        t('loginGuide.openWebsite', { provider: t('mimo.name') }),
        t('oauth.step1'),
        t('oauth.step2'),
        t('oauth.step3'),
        t('loginGuide.inCookies', { domain: 'aistudio.xiaomimimo.com' }),
        t('loginGuide.findFields', { fields: 'serviceToken、userId、xiaomichatbot_ph' }),
        t('loginGuide.useOauthTab'),
        t('loginGuide.paste'),
      ],
    },
    perplexity: {
      ...
      steps: [
        t('loginGuide.openWebsite', { provider: t('perplexity.name') }),
        t('oauth.step1'),
        t('oauth.step2'),
        t('oauth.step3'),
        t('loginGuide.inCookies', { domain: 'www.perplexity.ai' }),
        t('loginGuide.findField', { field: '__Secure-next-auth.session-token' }),
        t('loginGuide.paste'),
      ],
    },
  }

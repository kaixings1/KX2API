          ...
          <div className="flex items-center gap-3 p-3 rounded-lg bg-muted/30 hover:bg-muted/50 cursor-pointer transition-colors h-[68px]">
            ...
            <div className="flex-1 min-w-0">
              ...
              <div className="flex items-center gap-2 text-xs text-muted-foreground mt-0.5">
                ...
                {log.chatProxyProviderName && !log.providerName && (
                  <>
                    <span>·</span>
                    <span className="text-blue-400">{log.chatProxyProviderName}</span>
                    {log.chatProxyAccountName && <span>/ {log.chatProxyAccountName}</span>}
                  </>
                )}
                {log.chatUserInput && (
                  <>
                    <span>·</span>
                    <span className="truncate max-w-[120px]">"{log.chatUserInput.slice(0, 20)}"</span>
                  </>
                )}
              </div>
            </div>

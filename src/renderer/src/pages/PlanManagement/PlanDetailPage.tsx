  ...
  const loadPlan = useCallback(async () => {
    ...
    try {
      ...
      if (res.success && res.plan) {
        const p = res.plan as PlanDetail
        setPlan(p)
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex gap-2">
          ...
          <Button variant="outline" size="sm" onClick={handleExecute} disabled={plan.status === 'running'}>
      ...
      <Card>
        <CardHeader>
          <div className="flex items-center justify-between">
            ...
            <span className="text-xs text-muted-foreground">{getProgress()}% 完成</span>
          </div>
      ...
      <Dialog open={editOpen} onOpenChange={setEditOpen}>
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>修改计划基本信息</DialogDescription>
          </DialogHeader>
          <div className="space-y-4">
            <div>
              <Label>标题</Label>

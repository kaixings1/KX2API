...
export class MemoryStore {
  ...
  constructor(options: MemoryStoreOptions = {}) {
    ...
    this.globalDir = options.globalDir ?? `${os.homedir()}/.doge/memory`
  ...
  private fileFor(level: MemoryLevel): string | null {
    switch (level) {
      ...
      case 'project': return this.projectDir ? `${this.projectDir}/.doge/memory/project.json` : null
      case 'global': return `${this.globalDir}/global.json`
    }
  }

...
const STOP_WORDS = new Set(
  'the,and,for,are,but,not,you,all,can,her,was,one,our,out,has,have,that,this,with,from,they,would,there,their,what,about,which,when,make,like,time,just,know,take,people,into,year,your,good,some,could,them,see,other,than,then,now,look,only,come,its,over,think,also,back,after,use,two,how,work,first,well,way,even,new,want,because,any,these,give,day,most,been,had,did,get,got,much,many,where,each,why,still,being,every,between,need,down,should,both,same,last,long,little,own,here,old,tell,may,set,put,end,help,try,function,const,let,var,return,import,export,default,class,interface,type,public,private,async,await,new,this,throw,try,catch,finally,if,else,switch,case,break,continue,while,for,of,in,from,as,extends,implements,static,readonly,get,set,void,true,false,null,undefined,number,string,boolean,object,array,any,unknown,never,keyof,typeof,instanceof,find,search,look,explain,show,list,all,which,where,who,how,what,please,帮我,找出,搜索,查找,看看,解释,说明,显示,列出,所有,相关,关�,的,和,与,在,中,里,为,对,给,把,要,能,可以'.split(','),
)

...
归档 4（3 个旧 .d.ts + 零引用 barrel）；TrayManager/TrayWindow 保留（活）

## 清单（4）

| 完成 | 路径 | 处置 | D:\src 来源（严格匹配） |
| :---: | --- | --- | --- |
| [x] | `src/main/tray/TrayManager.d.ts` | | — |
| [x] | `src/main/tray/TrayWindow.d.ts` | | — |
| [x] | `src/main/tray/index.d.ts` | | — |
| [x] | `src/main/tray/index.ts` | | — |

...
- **目录**：`src/main/proxy/config`
- **孤儿数**：2（D:\src 可靠来源 0 个）
- **状态**：✅ 已完成
- **完成时间**：2026-09-18
...
全部归档（modelProfiles.ts 零引用 + 其旧 .d.ts）

## 清单（2）

| 完成 | 路径 | 处置 | D:\src 来源（严格匹配） |
| :---: | --- | --- | --- |
| [x] | `src/main/proxy/config/modelProfiles.d.ts` | | — |
| [x] | `src/main/proxy/config/modelProfiles.ts` | | — |

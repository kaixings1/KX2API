...
归档 4（3 个零引用模块 + 1 个旧 .d.ts）；toolCollection.ts 保留（活）

## 清单（4）

| 完成 | 路径 | 处置 | D:\src 来源（严格匹配） |
| :---: | --- | --- | --- |
| [x] | `src/main/proxy/tools/streamingToolExecutor.ts` | | — |
| [x] | `src/main/proxy/tools/toolCallCache.ts` | | — |
| [x] | `src/main/proxy/tools/toolCollection.d.ts` | | — |
| [x] | `src/main/proxy/tools/toolOrchestrator.ts` | | — |

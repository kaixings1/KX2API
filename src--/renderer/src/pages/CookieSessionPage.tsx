  ...
  return (
    <div className="space-y-6 max-w-4xl mx-auto">
      ...
      {statusData?.success && statusData.status && (
        <Card>
          <CardHeader>
            <CardTitle className="text-sm">Provider 状态 ({Object.keys(statusData.status).length})</CardTitle>
          </CardHeader>
          <CardContent>
            <div className="space-y-2">
              {Object.entries(statusData.status).map(([provider, info]) => {
                ...
                return (
                  <div key={vendor} className="flex items-center justify-between rounded border p-3">
                    <div className="flex items-center gap-2">
      ...
      {(Object.keys(credentialCache).length > 0) && (
        <Card>
          <CardHeader>
            <CardTitle className="text-sm">已获取凭证</CardTitle>
          </CardHeader>
          <CardContent>
            <div className="space-y-2">
